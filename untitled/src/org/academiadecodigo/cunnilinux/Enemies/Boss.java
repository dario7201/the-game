        ...
        switch (randomPos) {
            case 0:
                ...
                if (!(super.getCollisionDetector().isCrashed(this, DirectionType.RIGHT))) {
                    ...
                    deletePic();
                    picture = new Picture(getX(), getY(), "untitled/Utils/Pictures/Characters/boss_right.png");//DARIO FALTA COLLISION DETECTOR AQUI COMO NO PLAYER
                    picture.grow(4, 4);
                    picture.draw();
                }
                break;
            case 1:
                ...
                if (!(super.getCollisionDetector().isCrashed(this, DirectionType.DOWN))) {
                    ...
                    deletePic();
                    picture = new Picture(getX(), getY(), "untitled/Utils/Pictures/Characters/boss_down.png");//DARIO FALTA COLLISION DETECTOR AQUI COMO NO PLAYER
                    picture.grow(4, 4);
                    picture.draw();
                }
                break;
            case 2:
                ...
                if (!(super.getCollisionDetector().isCrashed(this, DirectionType.UP))) {
                    ...
                    getHitbox().translate(0, -movement);
                    deletePic();
                    picture = new Picture(getX(), getY(), "untitled/Utils/Pictures/Characters/boss_up.png");//DARIO FALTA COLLISION DETECTOR AQUI COMO NO PLAYER
                    picture.grow(4, 4);
                    picture.draw();
                }
                break;
            case 3:
                ...
                if (!(super.getCollisionDetector().isCrashed(this, DirectionType.LEFT))) {
                    ...
                    getHitbox().translate(-movement, 0);
                    deletePic();
                    picture = new Picture(getX(), getY(), "untitled/Utils/Pictures/Characters/boss_left.png");//DARIO FALTA COLLISION DETECTOR AQUI COMO NO PLAYER
                    picture.grow(4, 4);
                    picture.draw();
                }
                break;
